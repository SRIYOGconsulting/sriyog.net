    ...
    <div className="w-full">
      ...
      <section className="w-full sm:bg-[url('/images/home/1.jpg')] bg-cover bg-center bg-no-repeat min-h-[600px] flex flex-col sm:flex-row justify-between items-start sm:items-center md:p-0 md:pt-0 relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto w-full flex flex-col sm:flex-row justify-between items-start sm:items-center sm:px-6">
          ...
          <div className="flex flex-col justify-start sm:justify-center text-left  z-10 w-full sm:w-1/2 mt-4 px-6 sm:mt-0">
            ...
            <div className="mt-8 mb-8 sm:mb-0 md:mt-10 flex flex-row  gap-4 md:gap-6">
              <button className="border-2 border-[#0D5D59] py-2 md:py-3 px-4 md:px-8 rounded-md text-[#0D5D59] font-semibold hover:bg-[#0D5D59] hover:text-white transition-all duration-300 ease-in-out min-w-[130px] shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                About
              </button>
              <button className="bg-[#0D5D59] text-white px-4 md:px-10 py-3 rounded-md font-semibold hover:bg-opacity-90 transition-all duration-300 ease-in-out min-w-[150px] shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                Book Meeting
              </button>
            </div>
          </div>
