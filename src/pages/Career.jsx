...
const jobs = [
  {
    ...
    date: "2025-01-10",
    description:
      "Responsible for designing, developing, and maintaining mobile applications for Android and iOS platforms. Work with cross-functional teams to define, design, and ship new features."
  },
  {
    id: 2,
    title: "Web Developer",
    ...
    date: "2025-01-08",
    description:
      "Build and maintain responsive websites and web applications. Work with backend and frontend technologies to deliver optimized digital solutions."
  },
  {
    id: 3,
    ...
    date: "2025-01-05",
    description:
      "Create user-centered designs, wireframes, prototypes, and conduct usability testing to improve overall user experience."
  },
  {
    id: 4,
  ...
  },
  {
    ...
    date: "2025-01-01",
    description:
      "Plan, execute, and monitor digital marketing campaigns, SEO/SEM strategies, and social media activities to drive brand growth."
  },
  {
    id: 6,
  ...
  },
  {
    ...
    date: "2024-12-25",
    description:
      "Analyze website performance, conduct keyword research, track rankings, and optimize content to improve search engine visibility."
  },
  {
    id: 9,
