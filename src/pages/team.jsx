...
const OurTeam = () => {
  return (
    <div className="about-w-full bg-white">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-6 md:py-10">
        ...
        {/* PRESIDENT SECTION */}
        <div className="rounded-lg border border-gray-300 p-6 md:p-10 bg-white">
          <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
            <div className="flex flex-col items-center">
              ...
              <p className="text-lg text-gray-600 mt-1 text-center">C.T.O</p>
            </div>

            {/* Text */}
            <div className="flex-1 text-justify text-gray-700 leading-relaxed text-[15px] md:text-lg">
              <p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 mt-10">
          {teamMembers.map((member) => (
            <div
              key={member.id}
              className="border border-gray-300 rounded-lg p-4 shadow-sm flex flex-col items-center hover:shadow-md hover:-translate-y-1 transition-all"
            >
              <img
                src={member.image}
                alt={member.name}
