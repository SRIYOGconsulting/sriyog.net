    ...
    <div className='fixed right-0 top-[15%] min-h-screen z-20'>
        ...
        <div className='absolute top-[54%] right-4 '>
             <div className="relative flex items-center justify-center group mb-6"> 
                ...
                <div className="relative z-10 bg-[#074842] p-3 rounded-full">
              ...
              <div className='flex flex-col items-center justify-center gap-1 bg-[#25D366] p-3 rounded-full animate-bounce'>
