  ...
  return (
    <div className='fixed right-0 top-[15%] min-h-screen z-20'>
        ...
        <div className='relative cursor-pointer hover:scale-[1.01] transition-all duration-200'>
            ...
            <div className={`absolute top-14  w-[250px] transition-transform duration-300 ${menu ? "-translate-x-[270px]" : "translate-x-80"}`}>              
        ...
        <div className='absolute top-[54%] right-4 '>
             <div className="relative flex items-center justify-center group mb-6 "> 
                ...
                <div className="relative z-10 cursor-pointer bg-[#074842] p-3 rounded-full">
                  <svg onClick={()=>window.open('https://sriyog.com','_blank')} width="30px" height="30px" viewBox="0 0 24 24" className='cursor-pointer group-hover:rotate-[120deg] transition-transform duration-200' fill="#ebebeb" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className='flex flex-col items-center justify-center gap-1 bg-[#25D366] p-3 rounded-full animate-bounce cursor-pointer'>
                <svg onClick={()=>window.open('https://sriyog.com','_blank')}  width="28" height="28" viewBox="0 0 277 270" fill="none" xmlns="http://www.w3.org/2000/svg">
