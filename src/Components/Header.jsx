    ...
    <header className="header">
      <div className="max-w-7xl mx-auto flex items-center justify-between py-4 px-6">
        ...
        <nav className="flex items-center space-x-4">
          ...
          {/* Sliding Input */}
          <div className={`relative bg-white ml-2 mr-8 z-20 py-1 border rounded-md  focus:outline-none focus:ring-2 focus:ring-teal-600
                transition-all duration-300 ease-in-out
                ${showSearch ? "sm:w-[450px] lg:w-[550px] opacity-100 px-3 py-1" : "w-0 opacity-0 px-0 py-0 overflow-hidden"}`}
              style={{ height: "38px" }}>
                <button onClick={()=>setShowSearch(false)} className="absolute left-2 font-bold text-3xl bottom-1">
                  ‹
                </button>
                <input
                  type="text"
                  ...
                  placeholder="Search..."
                  className={`absolute left-8 right-0 top-0 bottom-0 border-none outline-none rounded-r-md  focus:outline-none  focus:ring-none
                    transition-all duration-300 ease-in-out
                    ${showSearch ? "w-full opacity-100 " : "w-0 opacity-0 px-0 py-0 overflow-hidden"}`}
                />
          </div>
          ...
          {!showSearch && <svg 
            ...
            version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="122.879px" height="119.799px" viewBox="0 0 122.879 119.799" fill={DarkIcon ? "black" : "white"} enable-background="new 0 0 122.879 119.799" xml:space="preserve">
            <g>
          ...
          <div>
            <button
              ...
              className={`text-2xl ml-2 mr-10 lg:mr-0 rounded-full h-8 w-8 ${
                DarkIcon
